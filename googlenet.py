...
def create_googlenet(weights_path=None):
    ...
    loss1_classifier = Dense(nbClass,name='loss1/classifier',W_regularizer=l2(0.0002))(loss1_drop_fc)
    ...
    loss2_classifier = Dense(nbClass,name='loss2/classifier',W_regularizer=l2(0.0002))(loss2_drop_fc)
    ...
    loss3_classifier = Dense(nbClass, name='loss3/classifier',W_regularizer=l2(0.0002))(pool5_drop_7x7_s1)
